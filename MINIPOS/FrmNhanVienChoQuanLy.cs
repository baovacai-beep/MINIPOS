...
namespace MINIPOS
{
    public partial class FrmNhanVienChoQuanLy : Form
    {
        public FrmNhanVienChoQuanLy()
        {
            InitializeComponent();

            this.FormClosed += FrmNhanVienChoQuanLy_FormClosed;
        }

        private void FrmNhanVienChoQuanLy_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }

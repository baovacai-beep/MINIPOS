...
namespace MINIPOS
{
    public partial class FrmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tk.TenVaiTro == "QuanLy")
                    mainForm = new FrmBanHangChoQuanLy();
                else if (tk.TenVaiTro == "NhanVien")
                    mainForm = new FrmBanHangChoNhanVien();
                else
        ...
        {
            bool dangXuat = (sender as FrmBanHangChoQuanLy)?.DangXuat
                         ?? (sender as FrmBanHangChoNhanVien)?.DangXuat ?? false;
